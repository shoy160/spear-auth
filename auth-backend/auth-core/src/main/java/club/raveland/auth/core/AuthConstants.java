...
public interface AuthConstants {
    ...
    String MAPPER_PACKAGE = "club.raveland.auth.dao";
    String REST_PACKAGE = "club.raveland.auth.web.rest";

    String HEADER_AUTHORIZATION = "Authorization";
    String HEADER_BEARER = "Bearer";
    String HEADER_POOL_ID = "auth-pool-id";
    String HEADER_APP_ID = "auth-app-id";
