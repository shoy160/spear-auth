...
import club.raveland.auth.web.utils.CookieUtil;
...
public class AuthorizeHandler {
    ...
    public String saveToken(Token token, ApplicationDTO app) {
        ...
        String accessToken = new JwtTokenBuilder(token).jwt(app.getTokenSecret(), expireAt);
    ...
    public Token verifyToken(String accessToken, String secret, String groupId) {
        ...
        Token token = JwtTokenBuilder.verify(accessToken, secret);
