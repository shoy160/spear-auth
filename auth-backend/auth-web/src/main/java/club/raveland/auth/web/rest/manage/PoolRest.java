...
import club.raveland.auth.entity.dto.PoolStatisticDTO;
import club.raveland.auth.service.PoolService;
import club.raveland.auth.web.command.manage.PoolCmd;
...
public class PoolRest extends BaseRest {
    ...
    public ResultDTO<PagedDTO<PoolDTO>> paged(@Valid PageVO pageVO) {
        PagedDTO<PoolDTO> paged = service.paged(pageVO.getPage(), pageVO.getSize());
