...
CREATE TABLE `t_application`  (
  ...
  `fd_deleted` tinyint(1) NOT NULL COMMENT '是否删除',
...
CREATE TABLE `t_login_log`  (
  ...
  `fd_state` tinyint(4) NOT NULL COMMENT '状态：1.成功,4.失败',
...
CREATE TABLE `t_pool`  (
  ...
  `fd_tenant_id` int(11) NOT NULL COMMENT '租户ID(所属用户ID)',
...
CREATE TABLE `t_user`  (
  ...
  `fd_gender` tinyint(4) NULL DEFAULT NULL COMMENT '性别',
